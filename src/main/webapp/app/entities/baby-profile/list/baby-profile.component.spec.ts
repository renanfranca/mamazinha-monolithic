...
describe('BabyProfile Management Component', () => {
  let comp: BabyProfileComponent;
  let fixture: ComponentFixture<BabyProfileComponent>;
  let service: BabyProfileService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'baby-profile', component: BabyProfileComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(BabyProfileComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.babyProfiles?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
