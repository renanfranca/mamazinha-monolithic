...
public class BreastFeedResource {
    ...
    private static final String ENTITY_NAME = "breastFeed";
    ...
    public ResponseEntity<List<BreastFeedDTO>> getAllBreastFeeds(
        ...
        Page<BreastFeedDTO> page;
        if (eagerload) {
            page = breastFeedService.findAllWithEagerRelationships(pageable);
        } else {
            page = breastFeedService.findAll(pageable);
        }
